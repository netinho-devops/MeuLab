...
#EMAIL_TO="VIVODCCInfraMPSINT@int.amdocs.com;VivoSTLead@int.amdocs.com;VIVODCCStabilizationLead@int.amdocs.com;vivost@int.amdocs.com;VIVOUpgradeSupport@int.amdocs.com;VIVOMCSSCloneEnvsTeam@int.amdocs.com"
#EMAIL_TO="hantonio@amdocs.com"
#EMAIL_TO="pedroa@amdocs.com"
#EMAIL_TO="jyoti.wabale@amdocs.com"
#EMAIL_TO="rnayeni@amdocs.com"
EMAIL_TO="anderson.oliveira@amdocs.com"
...
##################################################################
		...
		and HOTFIX_BUNDLES.BUNDLE_NAME = '${BUNDLENAME}' 
...
##################################################################################
		...
		and HOTFIX_MNG.UNIQUE_ID not in ( select UNIQUE_ID from HOTFIX_BUNDLES where HOTFIX_BUNDLES.BUNDLE_NAME = '${BUNDLENAME}');
		spool off
		exit;
		EOF`
...
echo "	</tr> </b>"
  ...
  showDaemonStatus "Core" "/users/gen/abpwrk1/ASMMBSS//Core/bin/xwd" 
   showDaemonStatus "G1_PROCESSING1" "/users/gen/abpwrk1/ASMMBSS/G1_PROCESSING1/bin/xwd"
   showDaemonStatus "G2_PROCESSING2" "/users/gen/abpwrk1/ASMMBSS/G2_PROCESSING2/bin/xwd"
   showDaemonStatus "G3_PROCESSING3" "/users/gen/abpwrk1/ASMMBSS/G3_PROCESSING3/bin/xwd"
   showDaemonStatus "G4_PROCESSING4" "/users/gen/abpwrk1/ASMMBSS/G4_PROCESSING4/bin/xwd"
...
then
   ssh amdocs@10.33.200.219 "ssh vivtools@vlty0532sl ' . ./.profile >/dev/null 2>&1 ; cd /vivnas/viv/vivtools/Scripts; GenerateEnvReleaseMail_netinho.ksh ${ENV_NUMBER} ${VERSION} ${PHASE} ${PROJECT} '" | /usr/sbin/sendmail -t
	 exit 0
fi
