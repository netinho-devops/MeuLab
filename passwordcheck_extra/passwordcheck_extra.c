 ...
 *
 * 18/03/2024 - Alteração para comportar a quantidade mínima de caracteres conforme política de senhas recomendada pela empresa auditora - Locaweb
 *
 *-------------------------------------------------------------------------
 */
#include "postgres.h"
...
/* GUC variables */
static int	password_min_len = 14;
static int	password_max_len = 30;
 ...
 */
static void
passwordcheck_extra_load_params(void)
{
	/* Special character set */
	DefineCustomStringVariable("passwordcheck_extra.special_chars",
	...
	DefineCustomBoolVariable("passwordcheck_extra.restrict_lower",
	...
	DefineCustomBoolVariable("passwordcheck_extra.restrict_upper",
	...
	DefineCustomBoolVariable("passwordcheck_extra.restrict_numbers",
	...
	DefineCustomIntVariable("passwordcheck_extra.minimum_length",
	...
	DefineCustomIntVariable("passwordcheck_extra.maximum_length",
...
_PG_init(void)
{
	...
	passwordcheck_extra_load_params();
